...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La verificación en dos pasos está activa. Escanea el código QR o introduce la clave en tu app de autenticación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para completar la activación, escanea el código QR o introduce la clave manualmente en tu app de autenticación',
        buttonText: 'Continuar',
    };
});
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="relative bg-card px-2 py-1"
                                >o introduce la clave manualmente</span
                            >
                        </div>
