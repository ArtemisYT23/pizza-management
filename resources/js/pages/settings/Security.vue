    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        ...
        >
            <p class="text-sm text-muted-foreground">
                Al activar la autenticación en dos pasos, al iniciar sesión se te
                pedirá un código de tu aplicación de autenticación (TOTP) en el
                móvil.
            </p>
        ...
        <div v-else class="flex flex-col items-start justify-start space-y-4">
            <p class="text-sm text-muted-foreground">
                Al iniciar sesión se te pedirá un código que obtendrás de la
